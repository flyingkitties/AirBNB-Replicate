  ...
  return (
    ...
    >
      ...
      p-2 rounded-full"
        ...
        >
          <Bars3Icon className="h-6 cursor-pointer mr-2 " />
          {session ? (
            <Image
      ...
      {searchInput && (
        <div className="flex flex-col col-span-3 mx-auto ">
          ...
          <div className="flex space-x-10">
            <button
              onClick={resetInput}
              className="flex-grow border border-red-400  hover:bg-red-400 hover:text-white text-black font-bold py-2 px-4 rounded-full"
            >
              Cancel
            </button>
            <button
